<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="EmpleadoVen.aspx.cs" Inherits="Arbiter.EmpleadoVen" %>
        ...
        <tr>
            ...
            <td align="center">
                ...
                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="X-Large" 
                    Text="Empleado con venta de mayor monto"></asp:Label>
