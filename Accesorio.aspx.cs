...
namespace Arbiter
{
    public partial class Accesorio : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                SqlCommand query2 = new SqlCommand("select marca,talla,color,imagen,tipo,montodolares from Producto where tipo = 'Accesorio'", conn2);
                conn2.Open();
