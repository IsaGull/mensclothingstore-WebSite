<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="ClientesFre.aspx.cs" Inherits="Arbiter.ClientesFre" %>
        ...
        <tr>
            ...
            <td align="center">
                ...
                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="X-Large" 
                    Text="Clientes más frecuentes"></asp:Label>
