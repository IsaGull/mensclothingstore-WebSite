...
namespace Arbiter
{
    public partial class Corbata : System.Web.UI.Page
    {
        int a = 1;
        int i = 0;
        int quedan = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                SqlCommand query2 = new SqlCommand("select marca,talla,color,imagen,tipo,montodolares from Producto where tipo = 'Corbata'", conn2);
                conn2.Open();
