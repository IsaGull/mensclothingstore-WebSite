<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="EmpleadoTol.aspx.cs" Inherits="Arbiter.EmpleadoTol" %>
        ...
        <tr>
            ...
            <td align="center">
                ...
                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="X-Large" 
                    Text="Empleado de mayor monto de ventas en total"></asp:Label>
